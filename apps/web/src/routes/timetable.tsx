    ...
    <main className="flex min-h-screen flex-col bg-background text-foreground">
      <header className="flex h-16 items-center justify-between border-b px-4">
        ...
        <nav className="flex items-center rounded-md bg-muted p-1">
          ...
          <StubTab to="/timetable" label="Timetable" icon={<CalendarDays className="size-3.5" />} />
      ...
      <section className="flex flex-1 items-center justify-center p-8">
        <div className="max-w-md rounded-md border border-dashed p-8 text-center">
          <h2 className="text-lg font-semibold">Timetable coming in next phase</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            The build view is ready for course search and section selection.
          </p>
        </div>
      </section>
    </main>
